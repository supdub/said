...
int main() {
    ...
    assert(normalize_to_simplified_chinese("VoiceKey 123").compare("VoiceKey 123") == 0);
#ifdef _WIN32
    ...
    assert(normalize_to_simplified_chinese("VoiceKey, English 3.14!") ==
           "VoiceKey, English 3.14!");
#endif
